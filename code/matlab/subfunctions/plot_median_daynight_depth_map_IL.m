%% plot_median_daynight_depth_map_IL.m
% Sub-function of IsraelTuna.m; plots median day and night dive depth in
% 1 x 1 degree bins.
...
for i = 0:1
    ...
    m_text(32, 39, ['n = ' num2str(length(unique(PSAT.TOPPID)))], 'FontSize', 20);
    ...
    cd([fdir '/figures']);
    if i == 0
        exportgraphics(gcf,'median_night_depth_map_IL.png','Resolution',300);
    elseif i == 1
        exportgraphics(gcf,'median_day_depth_map_IL.png','Resolution',300);
    end
