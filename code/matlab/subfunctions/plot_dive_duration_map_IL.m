%% plot_dive_duration_map_IL.m
% Sub-function of IsraelTuna.m; plots median dive duration in 
% 1 x 1 degree bins.
...
colormap(getPyPlot_cMap('YlGnBu',8)); 
...
cd([fdir '/figures']);
exportgraphics(gcf,'dive_duration_map_IL.png','Resolution',300)
