%% plot_daily_max_depth_map_IL.m
% Sub-function of IsraelTuna.m; plots median daily maximum dive depth in 
% 1 x 1 degree bins.
...
m_text(32, 39, ['n = ' num2str(length(unique(SSM.TOPPID(~isnan(SSM.max_Depth)))))], 'FontSize', 20)
